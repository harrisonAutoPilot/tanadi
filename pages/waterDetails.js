...
class WaterDetails extends React.Component <Props> {
 ...
 <View style={styles.content}>
           <View style={styles.username}>
                <View  style={styles.input1}>
                   ...
                   <View style={styles.info}><Text style = {styles.infoText}>Sachet Water</Text></View>
               </View>
               <View  style={styles.input1}>
                  <View style={styles.title}><Text style = {styles.titleText}>Quantity:</Text></View>
                  <View style={styles.info}><Text style = {styles.infoText}>42 bags</Text></View>
              </View>
              <View  style={styles.input1}>
                 <View style={styles.title}><Text style = {styles.titleText}>Delivery Address:</Text></View>
                 <View style={styles.info}><Text style = {styles.infoText}>Flat2, Wuse Zone4 Agric Quarter Fct Abuja.</Text></View>
             </View>
             <View  style={styles.input1}>
                <View style={styles.title}><Text style = {styles.titleText}>Description:</Text></View>
                <View style={styles.info}><Text style = {styles.infoText}>Please call me on 08062585959 when you arrive</Text></View>
            </View>
            <View  style={styles.input1}>
               <View style={styles.title}><Text style = {styles.titleText}>Transaction Code:</Text></View>
               <View style={styles.info}><Text style = {styles.infoTextC}>#TAN/ABJ/0832</Text></View>
           </View>
           <View  style={styles.input1}>
              <View style={styles.title}><Text style = {styles.titleText}>Date:</Text></View>
              <View style={styles.info}><Text style = {styles.infoText}>20/04/2020</Text></View>
          </View>
          <View  style={styles.input1}>
             <View style={styles.title}><Text style = {styles.titleText}>Transaction Status:</Text></View>
             <View style={styles.info}><Text style = {styles.infoTextS}>DELIVERED</Text></View>
         </View>
          ...
          <TouchableOpacity
              style = {styles.signButton}
               // onPress={this.saveData}>
                onPress={() => this.props.navigation.navigate('WaterOrderHistory')}>
